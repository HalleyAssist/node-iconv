...
if(testDE() && testC() && testC() && testDE() && testDE() && testDE() && testC() && testDE())
	...
	console.log(testDE(), testC(), testC(), testDE(), testDE(), testDE(), testC(), testDE())
...
function testDE (iconv) {
	//console.log(iconvDE.convert(TEST_STRING).toString(), "=====", GERMAN_TRANSLITERATION);
...
function testC (iconv) {
	//console.log(iconvEN.convert(TEST_STRING).toString(), "=====", ENGLISH_TRANSLITERATION);
